...
public class wavToDFPWMcli {
    ...
    public static void main(String args[]){
		...
		String newFile="";
		if(lastIndex == 0){
			//do nothing, this is in the home directory
			newFile = args[0].toString()+".dfpwm";
		}else if (lastIndex==-1){
			//do nothing, no period was found
			newFile = args[0].toString()+".dfpwm";

		}else{
			newFile = args[0].substring(0, lastIndex);
			newFile = newFile+ ".dfpwm";
